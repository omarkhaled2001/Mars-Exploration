...
#include"Mission.h"
#include<cmath>
Mountainous_Missions::Mountainous_Missions(int ed, int id, float tloc, int mdur, int sig) : Mission(ed, id, tloc, mdur, sig)
{

}

int Mountainous_Missions::In_Execuation_Event(int Current_Day, Rover*& r)
{
...
void Mountainous_Missions::AutoP_WD(int Current_Day)
{
	set_WD(Current_Day - get_FD());
